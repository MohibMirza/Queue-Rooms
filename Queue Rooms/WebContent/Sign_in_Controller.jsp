...
<body>
	...
	Name :
	<%=obj_Client_details.getUser_name()%><br> Email :
	<%=obj_Client_details.getEmail()%><br> id :
	<%=obj_Client_details.getId()%><br> Profile Picture :
	<%=obj_Client_details.getProfile_picture()%><br>
