...
<head>
  ...
  <title>SleepySAL - guest view</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Guest View</h1>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Welcome to MySal!</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_spreadsheet.svg" alt="">
                  </div>
                  <p>Welcome to MySal! Please register or login to your account to join or create a room. We hope you enjoy your office-hour queueing experience!</p>

                  <a target="_blank" rel="nofollow" href="https://undraw.co/">Register or login to your account &rarr;</a>
                </div>
              </div>
